...
# code from: https://gist.github.com/mkropat/7550097
...
def get_path(folderid, user_handle=UserHandle.current):   #  edg: changed default to current from common
    # call get path with the appropriate FOLDERID
    # documents_path = get_path(FOLDERID.Documents)
    # download_path = get_path(FOLDERID.Documents)
    fid = GUID(folderid)
