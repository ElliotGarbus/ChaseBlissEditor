...
mood = Pedal(name='Mood',
             ...
             logo='Images/mood.png', color=(254/255, 144/255, 114/255))
...
dark_world = Pedal(name='Dark World',
                   ...
                   logo='Images/dark world.png', color=(172/255, 180/255, 191/255))
...
thermae = Pedal(name='Thermae',
                ...
                cc20='Ramp', tap=True, logo='Images/thermae.png', color=(8/255, 22/255, 49/255))
...
tonal_recall = Pedal(name='Tonal Recall',
                     ...
                     logo='Images/tonal recall.png', color=(98/255, 147/255, 186/255))
...
warped_vinyl = Pedal(name='Warped Vinyl',
                     ...
                     logo='Images/warped vinyl.png', color=(12/255, 20/255, 33/255))
...
condor = Pedal(name='Condor',
               ...
               logo='Images/condor.png', color=(200/255, 200/255, 200/255))
...
brothers = Pedal(name='Brothers',
                 ...
                 logo='Images/brothers.png', color=(232/255, 193/255, 98/255))
...
gravitas = Pedal(name='Gravitas',
                 ...
                 logo='Images/gravitas.png', color=(54/255, 50/255, 46/255))
...
generation_loss = Pedal(name='Generation Loss',  # Need to add support for bypass + not tap 2nd stomp.
                        ...
                        logo='Images/generation loss.png', color=(1/255, 98/255, 156/255))
